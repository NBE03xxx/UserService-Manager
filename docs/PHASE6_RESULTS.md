...
実装受入は条件付き合格、一般公開用v0.1は未承認とする。主要機能と安全性の実機検証は完了したが、ネイティブbuildと配布往復試験、アクセシビリティの残る手動確認、公開homepage URLの確定が必要である。
...
1. GitHubの正式homepage URLを確定し、AppStream metadataへ設定する。
