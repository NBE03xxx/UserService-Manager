...
| I18N-002 | TC-I18N-002 |
| EXT-001 | TC-ARCH-001, アーキテクチャレビュー |
...
- README、要件、ロードマップ、アーキテクチャ、ADR、引き継ぎ文書の将来方針が一致
- cronバックエンドと手動言語選択が実装計画から除外されている
- systemdユニット拡張、高度ログ、追加ディストリビューション検証が期限未定の将来構想として明記されている
- 機能コードとv0.3の安全境界に変更がない
- 全既存テストが成功し、製品版v1.3.1のメタデータが一致する
